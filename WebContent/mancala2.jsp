...
<link rel="stylesheet" type="text/css"
	href="/Mancala_pubnub/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="/Mancala_pubnub/css/mancala.css">
...
<script type="text/javascript">
    ...
    var pubnub = PUBNUB.init({
        publish_key: 'pub-c-fe117c7b-0c2b-44bd-8ac0-e70cdae0c6db',
        subscribe_key: 'sub-c-09b6a55e-eb4b-11e5-bf9d-02ee2ddab7fe'
    });
...
<body>
	...
	<script src="/Mancala_pubnub/js/mancala.js" type="text/javascript"></script>
	<script src="/Mancala_pubnub/js/pubnub_communicator.js" type="text/javascript"></script>
	<script>
